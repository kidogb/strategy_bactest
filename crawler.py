...
get_all_bitmex("XBTUSD", "1h", save=True)
get_all_binance("ETHUSDT", "1d", save=True)
get_all_binance("ETHUSDT", "1h", save=True)
get_all_binance("DOTUSDT", "1d", save=True)
get_all_binance("DOTUSDT", "1h", save=True)
get_all_binance("EOSUSDT", "1d", save=True)
get_all_binance("EOSUSDT", "1h", save=True)
get_all_binance("ADAUSDT", "1d", save=True)
get_all_binance("ADAUSDT", "1h", save=True)
